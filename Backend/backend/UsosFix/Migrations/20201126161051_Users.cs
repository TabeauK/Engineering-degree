        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exchanges_Groups_SourceGroupId",
                        column: x => x.SourceGroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Exchanges_Groups_TargetGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupUser", x => new { x.GroupsId, x.StudentsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupUser_Users_StudentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exchanges_SourceGroupId",
                table: "Exchanges",
                column: "SourceGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Exchanges_TargetGroupId",
                table: "Exchanges",
